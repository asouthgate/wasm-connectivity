...
self.onmessage = async (e) => {
  ...
  try {
    ...
    if (fn === 'roost_finder_compute') {
      const [detectorsCsv, masterCsv, sunsetCsv, minutesAfterSunset, perNight, gridSize, captureRadius, diffusivity, t0, t1, loss] = args;
      const r = _roostFinder(
        detectorsCsv, masterCsv, sunsetCsv, minutesAfterSunset, !!perNight,
        gridSize, captureRadius, diffusivity, t0, t1, loss,
      );
