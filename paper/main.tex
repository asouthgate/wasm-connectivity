...
In the first case, a resistance map was generated at 1000x1000 resolution, then downsampled to lower resolutions, and the analysis code run with 5 repeats each.
It was expected that, in the browser context, the first run would be slowest.
