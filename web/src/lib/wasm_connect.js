 ...
 * @returns {string}
 */
export function solve_connectivity(resistance_data, nrows, ncols, nodata, point_data) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passArrayF64ToWasm0(resistance_data, wasm.__wbindgen_malloc);
        ...
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.solve_connectivity(ptr0, len0, nrows, ncols, nodata, ptr1, len1);
        deferred3_0 = ret[0];
        deferred3_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
