...
\author{
  Alex J. Southgate$^{1,*}$ \and Joanna Redihough$^{2}$ \\[1em]
...
Benchmarking code was wrapped in a ReactJS \cite{reactjs} applet which can be run locally and accessed via the code repository. Two benchmarks were run. 
