...
/**
 * @param {Float64Array} road_binary
 * @param {Float64Array} river_binary
 * @param {Float64Array} building_mask
 * @param {Float64Array} dtm
 * @param {Float64Array} dsm
 * @param {Float64Array} generic_resistance
 * @param {Float64Array} lamps
 * @param {Float64Array} landscape_conductance
 * @param {string} params_json
 * @returns {string}
 */
export function run_resistance_pipeline_browser(road_binary, river_binary, building_mask, dtm, dsm, generic_resistance, lamps, landscape_conductance, params_json) {
    let deferred10_0;
    let deferred10_1;
    try {
        const ptr0 = passArrayF64ToWasm0(road_binary, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArrayF64ToWasm0(river_binary, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passArrayF64ToWasm0(building_mask, wasm.__wbindgen_malloc);
        const len2 = WASM_VECTOR_LEN;
        const ptr3 = passArrayF64ToWasm0(dtm, wasm.__wbindgen_malloc);
        const len3 = WASM_VECTOR_LEN;
        const ptr4 = passArrayF64ToWasm0(dsm, wasm.__wbindgen_malloc);
        const len4 = WASM_VECTOR_LEN;
        const ptr5 = passArrayF64ToWasm0(generic_resistance, wasm.__wbindgen_malloc);
        const len5 = WASM_VECTOR_LEN;
        const ptr6 = passArrayF64ToWasm0(lamps, wasm.__wbindgen_malloc);
        const len6 = WASM_VECTOR_LEN;
        const ptr7 = passArrayF64ToWasm0(landscape_conductance, wasm.__wbindgen_malloc);
        const len7 = WASM_VECTOR_LEN;
        const ptr8 = passStringToWasm0(params_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len8 = WASM_VECTOR_LEN;
        const ret = wasm.run_resistance_pipeline_browser(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, ptr4, len4, ptr5, len5, ptr6, len6, ptr7, len7, ptr8, len8);
        deferred10_0 = ret[0];
        deferred10_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @returns {string}
 */
export function run_resistance_pipeline_wasm(road_binary, river_binary, building_mask, lcm, dtm, dsm, generic_resistance, lamps, params_json) {
    let deferred10_0;
    let deferred10_1;
    try {
        const ptr0 = passArrayF64ToWasm0(road_binary, wasm.__wbindgen_malloc);
        ...
        const ptr2 = passArrayF64ToWasm0(building_mask, wasm.__wbindgen_malloc);
        const len2 = WASM_VECTOR_LEN;
        const ptr3 = passArrayF64ToWasm0(lcm, wasm.__wbindgen_malloc);
        const len3 = WASM_VECTOR_LEN;
        const ptr4 = passArrayF64ToWasm0(dtm, wasm.__wbindgen_malloc);
        const len4 = WASM_VECTOR_LEN;
        const ptr5 = passArrayF64ToWasm0(dsm, wasm.__wbindgen_malloc);
        const len5 = WASM_VECTOR_LEN;
        const ptr6 = passArrayF64ToWasm0(generic_resistance, wasm.__wbindgen_malloc);
        const len6 = WASM_VECTOR_LEN;
        const ptr7 = passArrayF64ToWasm0(lamps, wasm.__wbindgen_malloc);
        const len7 = WASM_VECTOR_LEN;
        const ptr8 = passStringToWasm0(params_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len8 = WASM_VECTOR_LEN;
        const ret = wasm.run_resistance_pipeline_wasm(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, ptr4, len4, ptr5, len5, ptr6, len6, ptr7, len7, ptr8, len8);
        deferred10_0 = ret[0];
        deferred10_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @returns {string}
 */
export function solve_raster_sources_jacobi_cached(resistance_data, nrows, ncols, nodata, source_data, ground_data, max_iter, tol, rebuild_laplacian, use_dirichlet_ground) {
    let deferred4_0;
    let deferred4_1;
    try {
        ...
        const len2 = WASM_VECTOR_LEN;
        const ret = wasm.solve_raster_sources_jacobi_cached(ptr0, len0, nrows, ncols, nodata, ptr1, len1, ptr2, len2, max_iter, tol, rebuild_laplacian, use_dirichlet_ground);
        deferred4_0 = ret[0];
        deferred4_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
