...
export const ADVANCED_PRESETS = [
  {
    ...
    items: [
      { id:'ae200', name:'edge to edge',
        res:'test_grids/uniform_200_res.asc',
        src:'test_grids/adv_edge_src_200.asc',
        gnd:'test_grids/adv_edge_gnd_200.asc' },
      { id:'ac200', name:'center to ring',
        res:'test_grids/uniform_200_res.asc',
        src:'test_grids/adv_center_src_200.asc',
        gnd:'test_grids/adv_ring_gnd_200.asc' },
      { id:'ap200', name:'two patches',
        res:'test_grids/rand_terrain_200_res.asc',
        src:'test_grids/adv_patch_src_200.asc',
        gnd:'test_grids/adv_patch_gnd_200.asc' },
    ],
  },
  {
    group: '300×300',
    items: [
      { id:'ae300', name:'edge to edge',
        res:'test_grids/uniform_300_res.asc',
        src:'test_grids/adv_edge_src_300.asc',
        gnd:'test_grids/adv_edge_gnd_300.asc' },
      { id:'ac300', name:'center to ring',
        res:'test_grids/uniform_300_res.asc',
        src:'test_grids/adv_center_src_300.asc',
        gnd:'test_grids/adv_ring_gnd_300.asc' },
      { id:'ap300', name:'two patches',
        res:'test_grids/rand_terrain_300_res.asc',
        src:'test_grids/adv_patch_src_300.asc',
        gnd:'test_grids/adv_patch_gnd_300.asc' },
    ],
  },
  {
    group: '500×500',
    items: [
      { id:'ae500', name:'edge to edge',
        res:'test_grids/uniform_500_res.asc',
        src:'test_grids/adv_edge_src_500.asc',
        gnd:'test_grids/adv_edge_gnd_500.asc' },
      { id:'ac500', name:'center to ring',
        res:'test_grids/uniform_500_res.asc',
        src:'test_grids/adv_center_src_500.asc',
        gnd:'test_grids/adv_ring_gnd_500.asc' },
      { id:'ap500', name:'two patches',
        res:'test_grids/rand_terrain_500_res.asc',
        src:'test_grids/adv_patch_src_500.asc',
        gnd:'test_grids/adv_patch_gnd_500.asc' },
    ],
  },
];
