...
\author{
  Alex J. Southgate \\
  \small southgateJA@cardiff.ac.uk \\[1em]
  Joanna Redihough \\
}
\date{\today}
...
rendered in a React frontend using raster source mode (referred to as advanced mode in Circuitscape) for the test region.
