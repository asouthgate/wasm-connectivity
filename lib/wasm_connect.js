 ...
 * @returns {string}
 */
export function compute_roost_surface(x, y, counts, grid_size, capture_radius, diffusivity, t0, t1, loss) {
    let deferred5_0;
    let deferred5_1;
    try {
        ...
        const ptr3 = passStringToWasm0(loss, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len3 = WASM_VECTOR_LEN;
        const ret = wasm.compute_roost_surface(ptr0, len0, ptr1, len1, ptr2, len2, grid_size, capture_radius, diffusivity, t0, t1, ptr3, len3);
        deferred5_0 = ret[0];
        deferred5_1 = ret[1];
